...
Centroids = vertcat(propsFeatures(ismember({propsFeatures.FaceDir},{'down'})).Centroid);      % centroid of down facing features coordinates.
...
height = supportHeight(G);  % support height calculation
