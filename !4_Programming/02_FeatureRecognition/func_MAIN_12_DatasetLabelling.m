function propsFeatures = func_MAIN_12_DatasetLabelling(body)
...
resolution = 0.25; %resolution in mm
...
propsFeatures = cutFeatures_v3(G, propsFeatures, maxCutOffsetpx, cutOffsetPercent);
